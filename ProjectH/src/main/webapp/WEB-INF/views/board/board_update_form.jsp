...
<body>
	...
	<div class="board">
		...
		<div class="board_form">
			<form name="boardUpdateForm" action="board_update_save.do" method="post">
				<ul class="updateUl">
					<li class="updateLi1">
						<label class="updateLabel1">Title</label>
						<input type="text" name="title" id="title" value="<%=vo.getTitle()%>">
					</li>
					<li class="updateLi2">
						<label class="updateLabel2">Content</label>						
						<textarea rows="10" cols="50" name="content" id="content">
							<%=vo.getContent() %>				
						</textarea>
					</li>
					<li class="updateLi3">
						<label class="updateLabel3">updater</label>
						<input type="text" name="bname" id="bname" value="<%=vo.getBname() %>" readonly>
					</li>
					<li class="bform_btn">
